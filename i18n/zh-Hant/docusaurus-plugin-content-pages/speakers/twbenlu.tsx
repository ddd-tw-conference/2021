...
const i18n: SpeakerI18n = {
  ...
  title: [],
  description:
    "現職新創公司技術長。 過往曾經歷軟體工程師、MIS 系統工程師、微軟技術支援顧問、微軟 MVP (2014~2018)、資訊長。逾 15 年的 IT 生涯，一直以 [逆水行舟，不進則退] 的態度面對跌代愈加迅速的軟體產業。 目前耕耘產品 Based on Angular、.NET Core、Docker、Ceph、MongoDB、Redis、Machine learning…等領域。",
  detail: (
    <>
      <Typography>
        {
